...
All notable changes to Message Manager v2 will be documented in this file.
...
- Comprehensive dashboard for Message API management
...
- **message Bot** - Built-in chatbot functionality
...
Previous versions of Message Manager (v1.x.x) are now considered legacy.
...
**Message Manager v2** - Built with ❤️ by the Message API Team
